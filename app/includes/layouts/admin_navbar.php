  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href="<?php echo BASE_URL . 'lkjdfam@jodcnaosmmdloisdmnoe8iwejh/dashboard.php' ?>">Dashboard</a>
      </div>
        ...
        <?php if (isset($_SESSION['user'])): ?>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="<?php echo BASE_URL . 'lkjdfam@jodcnaosmmdloisdmnoe8iwejh/users/editProfile.php' ?>">Profile</a></li>
              <li><a href="<?php echo BASE_URL . 'lkjdfam@jodcnaosmmdloisdmnoe8iwejh/dashboard.php' ?>">Dashboard</a></li>
